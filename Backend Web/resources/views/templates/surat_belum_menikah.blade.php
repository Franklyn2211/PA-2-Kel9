    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="form-data">
                ...
                <div class="form-field">
                    <label>No. KK</label>
                    <span style="margin-left: 40px;">: {{ $family_card_number }}</span>
                </div>
                <div class="form-field">
            ...
            <p>adalah benar Penduduk Dusun II(Dua) Pasar Toruan Desa Ambarita Kecamatan Simanindo Kabupaten Samosir dan menurut data yang ada pada kami nama tersebut diatas<strong>"Belum Pernah Menikah"</strong></p>

            <p>Demikian Surat Keterangan ini dibuat dan diberikan pada yang bersangkutan untuk dipergunakan seperlunya</p>
        </div>
